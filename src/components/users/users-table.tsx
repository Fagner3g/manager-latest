    ...
    <Card>
      ...
      <CardContent>
        <Table>
          ...
          <TableBody>
            {users.length > 0 &&
              users.map(({ id, name, email, emailVerified, role, twoFactorAuthVerified, isTwoFactorAuthEnabled }) => (
                <TableRow key={id}>
                  ...
                  <TableCell>
                    {isTwoFactorAuthEnabled ? <Check color="#22c55e" className="" /> : <ShieldX color="#eab308" />}
                  </TableCell>
